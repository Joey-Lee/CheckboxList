...
class CheckBoxButton: UIButton {
    ...
    var checkedImage = UIImage(named: "checkedBox", in: Bundle(for:ChecklistView.self), compatibleWith: nil)
    var uncheckedImage = UIImage(named: "UnCheckedBox", in: Bundle(for:ChecklistView.self), compatibleWith: nil)
    var isOn = false
    var setupDone = false
    ...
    */
    ...
    func setShape(_ shape : String){
        if shape.lowercased() == "circle" || shape.lowercased() == "round"{
            checkedImage = UIImage(named: "CheckedCircle", in: Bundle(for:ChecklistView.self), compatibleWith: nil)
            uncheckedImage = UIImage(named: "UncheckedCircle", in: Bundle(for:ChecklistView.self), compatibleWith: nil)
        }
        else{
            checkedImage = UIImage(named: "CheckedBox", in: Bundle(for:ChecklistView.self), compatibleWith: nil)
            uncheckedImage = UIImage(named: "UncheckedBox", in: Bundle(for:ChecklistView.self), compatibleWith: nil)
        }
        if isOn{
            checkBox.image = checkedImage
            checkBox.image = checkBox.image!.withRenderingMode(.alwaysTemplate)
